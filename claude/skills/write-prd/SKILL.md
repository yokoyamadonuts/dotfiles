  ...
  questions: [
    {
      ...
      options: [
        ...
        {
          label: "インディーテンプレート（高速）",
          description: "5つの質問で構成。インディー開発者向け。アイデア検証〜MVP定義を1時間で完了"
        },
        {
          label: "自分のテンプレート",
...
- コア機能（3つ以内）:
  ...
  2. [機能2]
  3. [機能3]
- 開発期間: [Vibe Coding / Weekend / Standard]
- やらないこと: [明示的に除外するもの]

## マーケティング
- 無料版/無料ツール: [何を無料で提供するか]
- Build in Publicストーリー: [語れるストーリーは何か]
- ローンチプラットフォーム: [Product Hunt / X / Reddit / etc.]
```
...
**6. マーケティングフィット**（インディー向け）
- 「無料版/無料ツールは何ですか？」（Marc Lou方式: 無料ツールで集客→有料版にアップセル）
- 「Build in Publicで語れるストーリーはありますか？」（開発過程をコンテンツ化できるか）
- 「6秒で説明できますか？」（Jack Friks方式: 説明に30秒以上かかるなら複雑すぎる）
