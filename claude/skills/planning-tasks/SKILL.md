...
問題がゼロになるまで繰り返す（最大3回。3回で収束しない場合はAskUserQuestionでユーザーに相談する）。
...
- **japanese-tech-writing**: TODO.md のタスク説明文を書く際の日本語文章規範（簡潔さ・見出しの付け方）
